...
import 'package:blog/ui/list_video/list_video_page_state.dart';
...
class _ListVideoPageState extends ListVideoPageState {
  @override
  Widget build(BuildContext context) {
    controller.addListener(onScroll);
    return Scaffold(
      appBar: AppBar(
        title: Text("Latest Video",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.bold),),
        ...
        child: BlocBuilder<ListVideoBloc,ListVideoState>(
          builder: (context,state){
            if(state is ListVideoUnitializedState){
              ...
              return _buildListVideo(state.isReachedEnd, state.video);
            }
          },
        ),
      ),
  ...
  Widget _buildListVideo(bool isReachEnd,List<Video>list){
